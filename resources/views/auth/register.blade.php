    ...
    <div class="container"  style="margin-top: 83px;">
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block" style="background:#050478;padding-left:50px;">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4"><strong>REGISTRATION</strong></h1>
                            ...
                            <form class="user" method="post" action="register_member" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        ...
                                        <input type="text" class="form-control"
                                            name="middlename" placeholder="" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input  type="text" class="form-control" name="contact_no"
                                            placeholder="" id="phone" ng-model="tel" ng-intl-tel-input data-default-country="ph"required>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                        ...
                                        <select class="form-control form-select" id="addr_country" name="addr_country" required>
                                ...
                                <button type="submit" id="register_member"class="btn btn-warning btn-block"style="background-color:#ECC408;">REGISTER</button>
                            ...
                            <hr>
                               <div class="text-center">
                                    ...
                                    <a  href="{{url('/')}}"><strong>LOG IN</strong></a>
                               </div> 
                        </div>
                    </div>
                </div>
